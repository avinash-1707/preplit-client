...
export default function PreplitLanding() {
  return (
    <div className="bg-zinc-950 text-zinc-100 min-h-screen">
      <nav className="sticky top-0 w-full flex justify-between items-center py-5 px-12 border-b backdrop-blur-lg z-40">
        <h1 className="text-2xl font-bold">preplit</h1>
        <UserButton />
      </nav>
      {/* Hero Section */}
      <section className="relative min-h-screen flex items-center overflow-hidden">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-150 h-150 bg-indigo-500/10 rounded-full blur-3xl pointer-events-none" />

        <div className="container mx-auto px-6 relative z-10 max-w-6xl">
          <div className="max-w-3xl">
            <div className="font-mono text-emerald-400 text-sm mb-4">
              $ simulate_real_interview.sh
            </div>

            <h1 className="text-6xl font-bold leading-tight mb-6">
              Practice coding interviews the way they're{" "}
              <span className="text-indigo-400">actually conducted</span>
            </h1>
      ...
      {/* Problem Section */}
      <section className="py-32 bg-linear-to-b from-zinc-950 to-zinc-900">
        <div className="container mx-auto px-6 max-w-6xl">
          <h2 className="text-4xl font-bold text-center mb-4">
            You can solve LeetCode. You still fail interviews.
          </h2>
          <p className="text-center text-zinc-400 text-lg max-w-2xl mx-auto mb-16">
            Interview performance is a skill separate from problem-solving.
          </p>

          <div className="grid md:grid-cols-3 gap-8 mt-16">
            <div className="bg-zinc-800/50 border border-zinc-700 hover:border-red-500/50 rounded-xl p-8 transition-colors">
      ...
      <section className="py-32 bg-zinc-950">
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          <div className="space-y-0">
            {/* Step 1 */}
            <div className="grid md:grid-cols-[80px_1fr] gap-6 pb-12 border-l-2 border-zinc-700 relative">
              <div className="flex items-start justify-center pt-1">
                <div className="w-12 h-12 rounded-full bg-indigo-600 flex items-center justify-center font-bold text-lg -ml-6.25">
                  1
                </div>
              </div>
              <div className="pb-8">
            ...
            <div className="grid md:grid-cols-[80px_1fr] gap-6 pb-12 border-l-2 border-zinc-700 relative">
              <div className="flex items-start justify-center pt-1">
                <div className="w-12 h-12 rounded-full bg-indigo-600 flex items-center justify-center font-bold text-lg -ml-6.26">
                  4
                </div>
              </div>
              <div className="pb-8">
            ...
            <div className="grid md:grid-cols-[80px_1fr] gap-6 pb-0 border-l-2 border-transparent relative">
              <div className="flex items-start justify-center pt-1">
                <div className="w-12 h-12 rounded-full bg-indigo-600 flex items-center justify-center font-bold text-lg -ml-6.25 border-2 border-zinc-950">
                  5
                </div>
              </div>
              <div>
      ...
      <section className="py-32 bg-linear-to-b from-zinc-950 to-zinc-900">
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="bg-zinc-800/50 border border-zinc-700 rounded-xl p-8 text-left mb-12">
      ...
      <footer className="py-12 bg-zinc-950 border-t border-zinc-800">
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="font-mono text-indigo-400 text-xl font-bold">
              preplit
            </div>
